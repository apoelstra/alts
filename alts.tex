...
down into its constituent algorithms. Such a breaking-down is necessarily
subjective and gives an incomplete view of the system\footnote{Robert Pirsig,
Zen and the Art of Motorcycle Maintenance, 1974}, but is didactically necessary.

[TODO fix this list]
\begin{enumerate}
\item Chainstate determination.
\item Block verification.
\item Transaction generation.
\item Script execution / verification.
\item Blockchain extension and block creation.
\end{enumerate}
